        ...
        <div className="p-14 flex flex-col gap-5 py-28 md:py-14">
            ...
            <div className="flex flex-wrap gap-4">
                {homeIcons.map((item,index) => {
                    return (
                        <Link key={index} href={`/profile/settings?tab=${item.link}`} className="flex flex-col  bg-gray-100 rounded-lg cursor-pointer hover:bg-gray-200 w-[250px] max-w-[250px] dark:bg-dark dark:hover:bg-opacity-50 dark:hover:bg-white/30 ">
